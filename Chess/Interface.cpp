	...
	void Interface::drawBoard() {//prints board in cmd
		...
		for (int i = 0; i < WIDTH; ++i) {
			...
			for (int j = 0; j < WIDTH; ++j) {
				...
				case W_PAWN: { letter = 'P'; break; }
				case W_ROOK: { letter = 'R'; break; }
				case W_KNIGHT: { letter = 'N'; break; }
				case W_BISHOP: { letter = 'B'; break; }
				case W_QUEEN: { letter = 'Q'; break; }
				case W_KING: { letter = 'K'; break; }
				case B_PAWN: { letter = 'p'; break; }
				case B_ROOK: { letter = 'r'; break; }
				case B_KNIGHT: { letter = 'n'; break; }
				case B_BISHOP: { letter = 'b'; break; }
				case B_QUEEN: { letter = 'q'; break; }
				case B_KING: { letter = 'k'; break; }
				default: { letter = ' '; }
				}
				std::cout << " " << letter << " |";
			}
